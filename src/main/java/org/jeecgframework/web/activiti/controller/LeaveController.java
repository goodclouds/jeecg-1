...
public class LeaveController extends BaseController{
	...
	public AjaxJson leaveStart(Leave leave, HttpServletRequest request) {
		...
		String user = (String) request.getSession().getAttribute("loginUserName");		
	...
	@ResponseBody
	public AjaxJson reApplyTask(String taskId, Leave leave, Variable var, HttpServletRequest request) {
		AjaxJson j = new AjaxJson();
		leaveService.reApplyLeave(taskId,leave,var);
