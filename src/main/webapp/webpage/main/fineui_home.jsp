 ...
 <body class="gray-bg">
    ...
    <div class="col-sm-12">
        <blockquote class="text-warning" style="font-size:14px">您是否需要一款企业级J2EE快速开发平台，提高开发效率，缩短项目周期…
            ...
            <br>…………
            <h4 class="text-danger">那么，现在BOS来了</h4>
        </blockquote>
        <hr>
    </div>
    <div class="col-sm-3">
    ...
    <div class="col-sm-5">
        ...
        <p>BOS是一款基于代码生成器的J2EE快速开发平台，开源界“小普元”超越传统商业企业级开发平台。引领新的开发模式(Online Coding模式(自定义表单)->代码生成器模式->手工MERGE智能开发)， 可以帮助解决Java项目60%的重复工作，让开发更多关注业务逻辑。既能快速提高开发效率，帮助公司节省人力成本，同时又不失灵活性。她可以用于所有的Web应用程序，如:<b>MIS</b>，<b>CRM</b>，<b>OA</b>，<b>ERP</b>，<b>CMS</b>，<b>网站后台</b>，<b>微信管家</b>，等等，当然，您也可以对她进行深度定制，以做出更强系统。</p>
        <p>
            <b>当前版本：</b>v_3.7.8
        </p>
        <p>
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <p>我们提供基于BOS的二次开发服务，具体费用请联系官方。</p>
                    <p>同时，我们也提供以下服务：</p>
                    <ol>
                        <li>BOS工作流开发平台 (商业版)</li>
                        <li>Jeewx微信管家 (商业版)</li>
                        <li>OA办公系统 (商业版)</li>
                        <li>专业H5活动开发</li>
                    </ol>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <p><i class="fa fa-weixin"></i>微信公众号：<a href="javascript:;">BOS</a>
                    </p>
                    <p><i class="fa fa-credit-card"></i> 邮箱：<a href="javascript:;" class="邮箱">BOS@sina.com</a>
                    </p>
                </div>
            </div>
        </div>
                                ...
                                <div id="v55" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <ol>
											...
											<li>【改造】BOS前段js 国际化改造，采用i18n技术实现;</li>
                                ...
                                <div id="v54" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <ol>
											...
											<li>【功能改造】将不常改的js组件放进jar包 BOS-plugin-in,减少eclipse check js;</li>
                                ...
                                <div id="v53" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <ol>
											...
											<li>【功能升级】mave依赖非BOS官方的统一采用本地依赖方式，降低maven构建难度;</li>
											<li>【功能改造】BOS 用户账号字段改长一些;</li>
											...
											<li>【BUG】范围查询double类型字段错误问题;</li>
											<li>【BUG】BOS 新版3.7.3菜单加载慢问题解决;</li>
                                ...
                                <div id="v51" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <ol>
											...
											<li>【bug】BOS 用户功能代码事务不严谨，control的逻辑改到service里面;</li>
                                ...
                                <div id="v45" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <ol>
											...
											<li>日志输出格式修改;</li>
											<li>弹出窗口最大化JS，处理;</li>
                                            <li>BOS云插件下载地址：http://yun.jeecg.org </li>
                                            <li>更多插件发布，敬请期待。。</li>
                                        </ol>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                       <div class="alert alert-warning">此版本云应用插件开发版本，支持以插件方式升级平台功能，让我们共同期待后续版本的到来</div>
                                        <ol>
                                            ...
                                            <li>火狐下上传文件bug修复；</li>
                                            <li>用户删除，改成逻辑删除；</li>
                                            <li>BOS云应用平台中心发布：http://yun.jeecg.org </li>
                                            <li>插件发布：CMS系统</li>
                                            <li>插件发布：微信企业号管理平台</li>
                                            <li>更多插件发布，敬请期待。。</li>
                                        </ol>
        ...
        <div class="col-sm-4">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <hr>
                    <div class="alert alert-warning">BOS智能开发平台，可以应用在任何J2EE项目的开发中，尤其适合企业信息管理系统（MIS）、内部办公系统（OA）、企业资源计划系统（ERP） 、客户关系管理系统（CRM）等，其半智能手工Merge的开发方式，可以显著提高开发效率60%以上，极大降低开发成本。
                    </div>
                </div>
            </div>
        </div>
